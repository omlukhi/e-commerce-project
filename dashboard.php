...
$sql_select_order_can = "select * from `order` where `status`='Cancelled-By-Supplier' or `status`='Cancelled-By-Client' or `status`='Delivered' ";
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                ...
                <p>product Instock & Out of stock</p>
              </div>
              <div class="icon">
          ...
          <!-- ./col -->
          <div class="col-lg-3 col-6b d-none">
            <!-- small box -->
            <div class="small-box bg-info">
              <div class="inner">
                <h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                ...
                <p>Cancelled & delivered orders</p>
              </div>
              <div class="icon">
                <i class="ion ion-pie-graph"></i>
              </div>
